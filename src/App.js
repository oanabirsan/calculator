  ...
  switch (type) {
    ...
    case ACTIONS.EVALUATE:
      if (state.operation == null ||
        ...
        state.previousOperand == null) { return state }
      return {
        ...state,
        overwrite: true,
...
function evaluate({ currentOperand, previousOperand, operation }) {
  ...
  switch (operation) {
    ...
    case "√":
      ...
      break
    case "%":
      computation = (prev / 100) * curent
      break
    case "^":
      let sum = prev;
      for (let i = 0; i < curent-1; i++) {
        sum = sum * prev
      }
      computation = sum
      break
  ...
  return (
    <div className="calculator-grid">
      <div className="output">
        ...
        <div className="curent-operand">{formatOperand(currentOperand)}</div>
